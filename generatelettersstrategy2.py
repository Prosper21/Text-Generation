# Program generates text by picking the most popular ngram as  the seed
...
def preprocess_frequencies(frequencies, order):
    ...
    '''
    sequencer = {}
    ngrams_sorted_by_freq = [k for k in sorted(frequencies, key=frequencies.get, reverse=True)]
